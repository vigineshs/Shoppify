...
public class GetProduct extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String getProducts = "Select * from items where id='"+ itemId+"'";
        ...
        try {
			...
			while(productsReturned.next()) {
				...
				productJSON.put("productSubCategory", productsReturned.getString(6));
				productJSON.put("productCategory", productsReturned.getString(7));
