...
<head>
	...
	<title>Shopify - Shop Till You Drop</title>
	<!-- JS Libraries -->
	...
	<script src="//code.jquery.com/jquery-migrate-1.2.1.min.js"></script>
  	...
  	<!-- Typeahead JS -->
 	<!-- <script type="text/plain" src="https://raw.githubusercontent.com/mattboldt/typed.js/master/js/typed.js"></script>
	...
	<nav class="navbar navbar-default">
	  <div class="container-fluid">
	    ...
	    <div class="navbar-header">
	      ...
	      <a class="navbar-brand"  id="home">Shopify</a>
	    </div>
	
	    <!-- Collect the nav links, forms, and other content for toggling -->
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      
	      <!-- <form name="searchForm" id="searchForm" class="navbar-form navbar-left" role="search">
	        <div class="form-group">
	          <input type="text" id="keyword" name="keyword" class="form-control" placeholder="Search">
	        </div>
	      </form> -->
	      <ul class="nav navbar-nav navbar-right">
	        <li id="cart"><a><span class="glyphicon glyphicon-shopping-cart"></span></a></li>
	        <li id="logIn"><a><span class="glyphicon glyphicon-log-in"  data-toggle="modal" data-target="#userModal" ></span></a></li>
	        <li id="register"><a><span class="glyphicon glyphicon-user"  data-toggle="modal" data-target="#userModal"></span></a></li>
	        <li id="logOut"><a><span class="glyphicon glyphicon-log-out"></span></a></li>
	      </ul>
	    </div><!-- /.navbar-collapse -->
	  </div><!-- /.container-fluid -->
	</nav>
